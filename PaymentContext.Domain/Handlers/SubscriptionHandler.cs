  ...
  public class SubscriptionHandler : Notifiable<Notification>, IHandler<CreateBoletoSubscriptionCommand>
  {
    ...
    public ICommandResult Handle(CreateBoletoSubscriptionCommand command)
    {
      ...
      var payment = new BoletoPayment(
        ...
        command.TotalPaid,
        command.Payer,
        new Document(command.PayerDocument, EDocumentType.CPF),
        address,
        email
      );
      ...
      _emailService.Send(student.Name.GetFullName(), student.Email.Address, "Seja bem-vindo", "Sua assinatura foi criada");
